...
pub fn register<R: Runtime>(builder: Builder<R>) -> Builder<R> {
    builder.invoke_handler(tauri::generate_handler![
        ...
        instance::keymap_cmd::read_keybindings_file,
        instance::keymap_cmd::write_keybindings_file,
        instance::keymap_cmd::list_presets,
        instance::keymap_cmd::list_user_profiles,
        instance::keymap_cmd::save_user_profile,
        instance::keymap_cmd::delete_user_profile,
        instance::keymap_cmd::backup_instance_options_file,
        instance::keymap_cmd::has_options_backup,
        instance::keymap_cmd::restore_instance_options_backup,
        ...
        instance::save_cmd::get_exit_backup_enabled,
        instance::save_cmd::set_exit_backup_enabled,
        instance::save_cmd::get_backup_all_worlds_on_exit_enabled,
        instance::save_cmd::set_backup_all_worlds_on_exit_enabled,
